...
export const AuthTokensResponse = Type.Object(
  {
    accessToken: Type.String({
      description:
        "JWT de acceso. Incluir en header: Authorization: Bearer <token>. Expira en 15 min.",
      example: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
    }),
    refreshToken: Type.String({
      description:
        "Token opaco de 64 bytes (hex). Usar en POST /auth/refresh. Expira en 30 días. Rotación automática.",
...
export const ErrorResponse = Type.Object(
  {
    ...
    message: Type.Optional(
      Type.String({ description: "Descripción legible del error" }),
    ),
  },
  { $id: "ErrorResponse" },
);
...
export const RefreshBody = Type.Object(
  {
    refreshToken: Type.String({
      description:
        "Refresh token recibido en login o register. Se revoca y se emite uno nuevo (rotación).",
      example: "a3f8c2d1e4b5...",
    }),
  },
  { $id: "RefreshBody" },
...
export const LogoutBody = Type.Object(
  {
    refreshToken: Type.String({
      description:
        "Refresh token a revocar. Después de logout, el token queda inválido.",
      example: "a3f8c2d1e4b5...",
    }),
  },
  { $id: "LogoutBody" },
